...
@section('js')
    ...
    <script>
        ...
        $('#createCertificationModal').on('shown.bs.modal', function() {
        ...
        function autosaveCategory() {
            ...
            autosaveTimer = setTimeout(() => {
                ...
                $('#createCertificationForm').find('.is-invalid').removeClass('is-invalid');
                $('#createCertificationForm').find('.invalid-feedback').removeClass('.invalid-feedback');
