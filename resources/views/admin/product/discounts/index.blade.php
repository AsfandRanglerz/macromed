...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                "ajax": {
                    "url": "{{ route('productDiscounts.get', ['id' => $id]) }}",
                    "type": "GET",
                    "data": {
                        "_token": "{{ csrf_token() }}"
                    }
        ...
        function createDiscounts() {
            ...
            $.ajax({
                url: '{{ route('productDiscounts.create', ['id' => $id]) }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        function editDiscountsModal(id) {
            var showDiscounts = '{{ route('productDiscounts.show', ':id') }}';
            $.ajax({
        ...
        function updateDiscounts() {
            var updateDiscounts = '{{ route('productDiscounts.update', ':id') }}';
        ...
        $('#example').on('click', '#update-status', function() {
            ...
            $.ajax({
                url: '{{ route('productDiscountsBlock.update', ['id' => ':userId']) }}'.replace(
                    ':userId', userId),
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
        ...
        function deleteSubadmin(subadminId) {
            $.ajax({
                url: "{{ route('productDiscounts.delete', ['id' => ':subadminId']) }}".replace(':subadminId',
                    subadminId),
                type: 'GET',
                success: function(response) {
