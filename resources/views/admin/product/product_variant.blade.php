                                            ...
                                            <div class="variant-field">
                                                ...
                                                <div class="row col-12">
                                                    ...
                                                    <div class="form-group col-4">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="variants[0][actual_price]"
                                                            value="{{ old('variants.0.actual_price') }}">
                                                    </div>
                                                    <div class="form-group col-4">
                                                ...
                                                <div class="row col-12">
                                                    ...
                                                    <div class="form-group col-4">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="variants[0][chargeable_weight]"
                                                            value="{{ old('variants.0.chargeable_weight') }}">
                                                    </div>
                                                </div>
                                                <div class="form-group col-12">
                                                    <label>Description <span class="text-danger">*</span></label>
                                                    <textarea name="variants[0][description]" id="long_description" cols="30" rows="5" class="form-control ">{{ old('variants.0.description') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        <div class="variant-field">
            <div class="row col-12">
                <div class="form-group col-4">
                    ...
                    <input type="text" class="form-control" name="variants[${variantCount}][sku]"
                        value="{{ old('variants.${variantCount}.sku') }}">
                </div>
                <div class="form-group col-4">
                    <label>Packing</label>
            ...
            <div class="row col-12">
                ...
                <div class="form-group col-4">
                    <label>Actual Price/Unit</label>
                    <input type="text" class="form-control" name="variants[${variantCount}][actual_price]"
                        value="{{ old('variants.${variantCount}.actual_price') }}">
                </div>
                <div class="form-group col-4">
                    <label>Selling Price/Unit</label>
                    <input type="text" class="form-control" name="variants[${variantCount}][selling_price]"
                        value="{{ old('variants.${variantCount}.selling_price') }}">
                </div>
            </div>
            <div class="row col-12">
                <div class="form-group col-4">
                ...
                <div class="form-group col-4">
                    <label>Shipping Chargeable Weight</label>
                    <input type="text" class="form-control" name="variants[${variantCount}][chargeable_weight]"
                        value="{{ old('variants.${variantCount}.chargeable_weight') }}">
                </div>
            </div>
            <div class="form-group col-12">
                <label>Description <span class="text-danger">*</span></label>
                <textarea name="variants[${variantCount}][description]" id="" cols="30" rows="5"
                    class="form-control long_description">{{ old('variants.${variantCount}.description') }}</textarea>
            </div>
            <div class="col-md-3 col-sm-3 col-lg-3">
                <div class="form-group" style="margin-top: 29px">
                    <button type="button" class="btn btn-danger removeVariantBtn"><i class="fa fa-trash"></i></button>
                </div>
            </div>
        </div>
        `;
