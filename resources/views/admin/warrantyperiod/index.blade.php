        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Warranty Period</h5>
    ...
    <script>
        ...
        function createNumberOfUse() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    toastr.success('Warranty Period Created Successfully!');
        ...
        function deleteNumberOfUse(id) {
            $.ajax({
                ...
                type: 'GET',
                success: function(response) {
                    toastr.success('Warranty Period Deleted Successfully!');
